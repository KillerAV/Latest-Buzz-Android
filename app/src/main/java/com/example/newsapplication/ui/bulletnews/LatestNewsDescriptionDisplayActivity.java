...
public class LatestNewsDescriptionDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String category = intent.getStringExtra(AppConstants.EXTRA_CATEGORY);
        String description = intent.getStringExtra(AppConstants.EXTRA_DESCRIPTION);
        String newsImageUrl = intent.getStringExtra(AppConstants.EXTRA_IMAGE_URL);
        String url = intent.getStringExtra(AppConstants.EXTRA_URL);
