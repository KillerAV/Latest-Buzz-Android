...
import com.example.newsapplicationroom.bulletnews.LatestNewsDescriptionDisplay;
...
public class LatestNewsAdapter extends RecyclerView.Adapter<LatestNewsAdapter.LatestNewsHolder> {
    ...
    public class LatestNewsHolder extends RecyclerView.ViewHolder {
        ...
        public void setNewsEntity(LatestNewsEntity newsEntity) {
            ...
            GlideOperations.insertImage(context, imageUrl, progressBar, imageView, R.drawable.no_image_found);

            cardView.setOnClickListener(v -> {
                Intent intent = new Intent(context, LatestNewsDescriptionDisplay.class);
